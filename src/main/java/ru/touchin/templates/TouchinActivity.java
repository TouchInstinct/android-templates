...
public abstract class TouchinActivity<TLogic extends Logic> extends ViewControllerActivity<TLogic> {
    ...
    /**
     * Returns if activity is launching by default (Startup/Splash or even Main) to enable multiple activities bug workaround.
     * Details http://code.google.com/p/android/issues/detail?id=2373.
     *
     * @return True if activity is launcher.
     */
